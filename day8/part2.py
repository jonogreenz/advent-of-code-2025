...
if __name__ == "__main__":
    ...
    while len(current_circuits) > 1:
        closest_pair = closest_positions[it]
        ...
        it += 1
        latest_pair = closest_pair

    pair1_xyz = all_xyz_positions[latest_pair[1][0]]
    pair2_xyz = all_xyz_positions[latest_pair[1][1]]
    print(f"Final circuits: {current_circuits}, last merged pair: {latest_pair}")
    print(f"Final pair x multiplication: {pair1_xyz[0] * pair2_xyz[0]}")
